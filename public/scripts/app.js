...
var DecisionApp = function (_React$Component) {
    ...
    _createClass(DecisionApp, [{
        ...
        value: function handlePick() {
            var randomNumber = Math.floor(Math.random() * this.state.options.length) + 1;
            var randomOption = this.state.options[randomNumber];
            alert(randomOption);
        }
    }, {
        key: "handleAddOption",
        ...
        value: function render() {
            ...
            var subtitle = "Life in the hands of the computer";
